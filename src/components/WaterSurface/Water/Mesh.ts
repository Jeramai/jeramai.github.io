...
class WaterMesh extends Mesh {
  ...
  constructor(geometry: any, options: WaterOptions = {}) {
    ...
    (this.material as any).uniforms['tReflectionMap'].value = reflector.getRenderTarget().texture;
    (this.material as any).uniforms['tRefractionMap'].value = refractor.getRenderTarget().texture;
    ...
    (this.material as any).uniforms['fxDistortionFactor'].value = fxDistortionFactor;
    (this.material as any).uniforms['fxDisplayColorAlpha'].value = fxDisplayColorAlpha;
